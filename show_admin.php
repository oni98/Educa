...
if (isset($_POST['update'])) {
    ...
    $role = $_POST['role'];
    $i=0;//// here $i for get array value;
...
$query = "SELECT * FROM signup WHERE role !='user' order by name asc ";
            $data = mysqli_query($connect, $query);
...
?>
            ...
            <?php echo"
                <td><a href='admin_delete.php?email=$result[email]&pass=$result[pass]' onclick='return checkdelete()'>Remove</a></td>" 
            ?>
            </tr>
